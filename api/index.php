					...
					<div class="destinations_container item_grid">
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="destinations.html"><?php echo $row['city']; ?></a></div>
								<div class="destination_subtitle"><p><?php echo $row['description']; ?></p></div>
								<div class="destination_price"><?php echo $row['currency']." ".$row['price']; ?></div>
							</div>
						</div>
